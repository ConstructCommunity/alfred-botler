  ...
  embed() {
    return new MessageEmbed()
      ...
      .addFields([
        ...
        { name: ':C3: Construct 3 Manual:', value: '[Read Manual ➚](https://www.construct.net/make-games/manuals/construct-3)', inline: true },
        { name: ':C2: Construct 2 Manual:', value: '[Read Manual ➚](https://www.scirra.com/manual/1/construct-2)', inline: true },
      ])
      .addFields([
