...
export default class PromoApp extends Template {
  ...
  embed() {
    return new MessageEmbed()
      ...
      .addFields('Why the addional approval process?', 'This process ensures that no malicious content is being published. Your content will be up and available after the process is done.');
  }
}
