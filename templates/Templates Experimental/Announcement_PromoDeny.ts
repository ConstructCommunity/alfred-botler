...
export default class PromoDeny extends Template {
  ...
  embed() {
    return new MessageEmbed()
      ...
      .addField('What are my options?', 'Your content breaks one or more of our channel rules. If you think that it doesn\'t, gently ask a member of the staff for more details');
  }
}
