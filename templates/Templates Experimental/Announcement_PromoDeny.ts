...
export default class PromoDeny extends Template {
	...
	embed() {
		return new MessageEmbed()
			...
			.setColor(16711680)
			.setThumbnail(
				`${CONSTANTS.GITHUB.RAW_REPO_URL_PREFIX}/assets/mini/Erroricon.png`
			)
			.setAuthor(
				'PROMOTION REJECTED!',
			...
			.addField(
				'What are my options?',
				"Your content breaks one or more of our channel rules. If you think that it doesn't, gently ask a member of the staff for more details"
			);
	}
}
