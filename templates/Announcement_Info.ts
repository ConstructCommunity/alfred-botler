		...
		return {
			...
			fields: [
				...
				},
				{
					...
					value:
						'[Open Link ➚](https://github.com/ConstructCommunity/alfred-botler/blob/master/README.md)',
				},
				{
				...
				},
				{
					...
					value:
						'[Open Link ➚](https://www.construct.net/make-games/buy-construct)',
				},
			],
			footer: {
